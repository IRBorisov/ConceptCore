// MathLexerImpl.hpp generated by reflex 3.3.8 from src/MathLexerImpl.l

#define REFLEX_VERSION "3.3.8"
...
{ return TokenID::END; }
            ...
            break;
          case 1: // rule src/MathLexerImpl.l:48: "+" :
{ return TokenID::PLUS; }
            break;
          case 2: // rule src/MathLexerImpl.l:49: "-" :
{ return TokenID::MINUS; }
            break;
          case 3: // rule src/MathLexerImpl.l:50: "*" :
{ return TokenID::MULTIPLY; }
            break;
          case 4: // rule src/MathLexerImpl.l:51: ">" :
{ return TokenID::GREATER; }
            break;
          case 5: // rule src/MathLexerImpl.l:52: "<" :
{ return TokenID::LESSER; }
            break;
          case 6: // rule src/MathLexerImpl.l:53: \x{2265} :
{ return TokenID::GREATER_OR_EQ; }
            break;
          case 7: // rule src/MathLexerImpl.l:54: \x{2264} :
{ return TokenID::LESSER_OR_EQ; }

            break;
          case 8: // rule src/MathLexerImpl.l:56: "=" :
{ return TokenID::EQUAL; }
            break;
          case 9: // rule src/MathLexerImpl.l:57: \x{2260} :
{ return TokenID::NOTEQUAL; }

            break;
          case 10: // rule src/MathLexerImpl.l:59: \x{2200} :
{ return TokenID::FORALL; }
            break;
          case 11: // rule src/MathLexerImpl.l:60: \x{2203} :
{ return TokenID::EXISTS; }

            break;
          case 12: // rule src/MathLexerImpl.l:62: \x{00AC} :
{ return TokenID::NOT; }
            break;
          case 13: // rule src/MathLexerImpl.l:63: "&" :
{ return TokenID::AND; }
            break;
          case 14: // rule src/MathLexerImpl.l:64: \x{2228} :
{ return TokenID::OR; }
            break;
          case 15: // rule src/MathLexerImpl.l:65: \x{21D2} :
{ return TokenID::IMPLICATION; }
            break;
          case 16: // rule src/MathLexerImpl.l:66: \x{21D4} :
{ return TokenID::EQUIVALENT; }

            break;
          case 17: // rule src/MathLexerImpl.l:68: :\x{2208} :
{ return TokenID::PUNC_ITERATE; }
            break;
          case 18: // rule src/MathLexerImpl.l:69: \x{2208} :
{ return TokenID::IN; }
            break;
          case 19: // rule src/MathLexerImpl.l:70: \x{2209} :
{ return TokenID::NOTIN; }
            break;
          case 20: // rule src/MathLexerImpl.l:71: \x{2286} :
{ return TokenID::SUBSET_OR_EQ; }
            break;
          case 21: // rule src/MathLexerImpl.l:72: \x{2282} :
{ return TokenID::SUBSET; }
            break;
          case 22: // rule src/MathLexerImpl.l:73: \x{2284} :
{ return TokenID::NOTSUBSET; }

            break;
          case 23: // rule src/MathLexerImpl.l:75: \x{00D7} :
{ return TokenID::DECART; }
            break;
          case 24: // rule src/MathLexerImpl.l:76: \x{222A} :
{ return TokenID::UNION; }
            break;
          case 25: // rule src/MathLexerImpl.l:77: \x{2229} :
{ return TokenID::INTERSECTION; }
            break;
          case 26: // rule src/MathLexerImpl.l:78: \x{005C} :
{ return TokenID::SET_MINUS; }
            break;
          case 27: // rule src/MathLexerImpl.l:79: \x{2206} :
{ return TokenID::SYMMINUS; }
            break;
          case 28: // rule src/MathLexerImpl.l:80: \x{212C} :
{ return TokenID::BOOLEAN; }

            break;
          case 29: // rule src/MathLexerImpl.l:82: pr{index} :
{ return TokenID::SMALLPR; }
            break;
          case 30: // rule src/MathLexerImpl.l:83: Pr{index} :
{ return TokenID::BIGPR; }
            break;
          case 31: // rule src/MathLexerImpl.l:84: Fi{index} :
{ return TokenID::FILTER; }
            break;
          case 32: // rule src/MathLexerImpl.l:85: card :
{ return TokenID::CARD; }
            break;
          case 33: // rule src/MathLexerImpl.l:86: bool :
{ return TokenID::BOOL; }
            break;
          case 34: // rule src/MathLexerImpl.l:87: red :
{ return TokenID::REDUCE; }
            break;
          case 35: // rule src/MathLexerImpl.l:88: debool :
{ return TokenID::DEBOOL; }

            break;
          case 36: // rule src/MathLexerImpl.l:90: D :
{ return TokenID::DECLARATIVE; }
            break;
          case 37: // rule src/MathLexerImpl.l:91: R :
{ return TokenID::RECURSIVE; }
            break;
          case 38: // rule src/MathLexerImpl.l:92: I :
{ return TokenID::IMPERATIVE; }

            break;
          case 39: // rule src/MathLexerImpl.l:94: Z :
{ return TokenID::LIT_INTSET; }
            break;
          case 40: // rule src/MathLexerImpl.l:95: \x{2205} :
{ return TokenID::LIT_EMPTYSET; }
            break;
          case 41: // rule src/MathLexerImpl.l:96: {number} :
{ return TokenID::LIT_INTEGER; }

            break;
          case 42: // rule src/MathLexerImpl.l:98: F{number} :
{ return TokenID::ID_FUNCTION; }
            break;
          case 43: // rule src/MathLexerImpl.l:99: P{number} :
{ return TokenID::ID_PREDICATE; }
            break;
          case 44: // rule src/MathLexerImpl.l:100: R{number} :
{ return TokenID::ID_RADICAL; }

            break;
          case 45: // rule src/MathLexerImpl.l:102: {global_id} :
{ return TokenID::ID_GLOBAL; }
            break;
          case 46: // rule src/MathLexerImpl.l:103: {local_id} :
{ return TokenID::ID_LOCAL; }

            break;
          case 47: // rule src/MathLexerImpl.l:105: ":=" :
{ return TokenID::PUNC_ASSIGN; }
            break;
          case 48: // rule src/MathLexerImpl.l:106: ":==" :
{ return TokenID::PUNC_DEFINE; }
            break;
          case 49: // rule src/MathLexerImpl.l:107: "::=" :
{ return TokenID::PUNC_STRUCT; }
            break;
          case 50: // rule src/MathLexerImpl.l:108: "(" :
{ return TokenID::PUNC_PL; }
            break;
          case 51: // rule src/MathLexerImpl.l:109: ")" :
{ return TokenID::PUNC_PR; }
            break;
          case 52: // rule src/MathLexerImpl.l:110: "{" :
{ return TokenID::PUNC_CL; }
            break;
          case 53: // rule src/MathLexerImpl.l:111: "}" :
{ return TokenID::PUNC_CR; }
            break;
          case 54: // rule src/MathLexerImpl.l:112: "[" :
{ return TokenID::PUNC_SL; }
            break;
          case 55: // rule src/MathLexerImpl.l:113: "]" :
{ return TokenID::PUNC_SR; }
            break;
          case 56: // rule src/MathLexerImpl.l:114: "|" :
{ return TokenID::PUNC_BAR; }
            break;
          case 57: // rule src/MathLexerImpl.l:115: "," :
{ return TokenID::PUNC_COMMA; }
            break;
          case 58: // rule src/MathLexerImpl.l:116: ";" :
{ return TokenID::PUNC_SEMICOLON; }

            break;
          case 59: // rule src/MathLexerImpl.l:118: \n :
{ lineBase += static_cast<StrPos>(columno() + 1); }
            break;
          case 60: // rule src/MathLexerImpl.l:119: [ \t]+ :
;
            break;
          case 61: // rule src/MathLexerImpl.l:121: . :
